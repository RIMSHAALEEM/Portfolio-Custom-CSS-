    ...
    <div className='relative min-h-screen'>
     ...
     <div className='container h-[calc(100vh-120px)] grid items-center'>
        <div className='space-y-4 bg-[#ffffff98] w-fit p-4'>
            ...
            <h2 className='text-4xl sm:text-6xl font-bold'>Rimsha <span className='text-blue-500'>Aleem</span></h2>
            ...
            <Link href="/about-us "><button className='bg-blue-500 mt-5 text-white px-6 py-2 rounded-3xl text-[14px] sm:text[16px]'>Read More</button></Link>
        </div>
     </div>
    </div>
  )
